...
<div class="flex items-center justify-between flex-wrap gap-3">
    <div>
        <h1 class="text-xl font-bold text-gray-900">Kelola Galeri</h1>
        <p class="text-[13px] text-gray-500 mt-0.5">Manajemen galeri foto dan dokumentasi kegiatan</p>
    </div>
...
@section('content')
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="p-5 border-b border-gray-100">
            <p class="text-[13px] text-gray-500">Daftar galeri foto diurutkan dari yang terbaru. Pastikan foto berkualitas baik dan ukuran file tidak lebih dari 2MB.</p>
        </div>

        <div class="p-5">
            <table id="tabel-galeri" class="w-full text-sm" style="width:100%">
                <thead>
                    <tr>
                        <th class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider pb-3">#</th>
                        <th class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider pb-3">Preview</th>
    ...
    <div id="modal-hapus"
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6 text-center">
            ...
            <h3 class="font-bold text-gray-900 mb-1">Hapus Galeri?</h3>
            <p class="text-sm text-gray-500 mb-6">
                Galeri ini akan dihapus permanen beserta filenya.
            </p>
    ...
    $(document).ready(function() {
        $('#tabel-galeri').DataTable({
            ...
            columns: [
                ...
                { data: 'judul_galeri', name: 'judul_galeri' },
