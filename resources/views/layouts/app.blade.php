        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-[260px] bg-white border-r border-gray-100
            ...
            <div class="flex items-center justify-between px-5 h-[60px] border-b border-gray-100 flex-shrink-0">
                <div class="flex items-center gap-3">
                    <div class="h-10 w-10 flex items-center justify-center flex-shrink-0 overflow-hidden">
                        <img src="{{ asset('assets/img/logo.png') }}" alt="Logo" class="w-full h-full object-contain">
                    </div>
                    <span class="brand-font font-bold text-gray-900 text-[15px] tracking-tight">DINAS PERPUSTKAAN DAN
                        KEARSIPAN</span>
                </div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
                ...
                <div x-data="{ open: {{ $isProfilActive ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center gap-3">
                            <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="{{ $isProfilActive ? '2.2' : '1.8' }}"
                    ...
                    <div x-show="open" style="display: none;" x-transition:enter="transition ease-out duration-200"
                        ...
                        x-transition:enter-end="opacity-100 translate-y-0" class="pl-9 pr-3 pt-1 pb-2 space-y-1 mt-1">
                        <a href="{{ route('admin.tentang-kami') }}"
                            class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.tentang-kami') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Tentang
                            Kami</a>
                        <a href="{{ route('admin.visi-misi') }}"
                            class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.visi-misi') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Visi
                            & Misi</a>
                        <a href="{{ route('admin.struktur-organisasi') }}"
                            class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.struktur-organisasi') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Struktur
                            Organisasi</a>
                        <a href="{{ route('admin.tupoksi') }}"
                            class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.tupoksi') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Tupoksi</a>
                        <a href="{{ route('admin.kontak-kami') }}"
                            class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.kontak-kami') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Kontak
                            Kami</a>
                        <a href="{{ route('admin.pejabat.index') }}"
                            class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.pejabat.*') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Pejabat
                            & Tim</a>
                    </div>
                </div>
                ...
                @if(auth()->user()->hasPermission('view_arsip'))
                    ...
                    <a href="{{ route('arsip.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeArsip ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_berita'))
                    ...
                    <a href="{{ route('berita.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeBerita ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_koleksi'))
                    ...
                    <a href="{{ route('koleksi.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeKoleksi ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_kategori_buku'))
                    ...
                    <a href="{{ route('kategori-buku.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeKategoriBuku ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_buku'))
                    ...
                    <a href="{{ route('buku.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeBuku ? '2.2' : '1.8' }}"
                                d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                ...
                @if(auth()->user()->hasPermission('view_kegiatan'))
                    ...
                    <a href="{{ route('kegiatan.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeKegiatan ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_galeri'))
                    ...
                    <a href="{{ route('galeri.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeGaleri ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_video'))
                    ...
                    <a href="{{ route('video.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeVideo ? '2.2' : '1.8' }}"
                                d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeVideo ? '2.2' : '1.8' }}" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Video
                    </a>
                @endif
                ...
                <a href="{{ route('faq.index') }}"
                    ...
                    <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="{{ $activeFaq ? '2.2' : '1.8' }}"
                ...
                <a href="{{ route('link-access.index') }}"
                    ...
                    <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="{{ $activeLinkAccess ? '2.2' : '1.8' }}"
                            d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                    </svg>
                    Link Access
                </a>

                @if(auth()->user()->hasPermission('view_berita') || auth()->user()->hasPermission('view_layanan'))
                    ...
                    <a href="{{ route('infografis.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeInfografis ? '2.2' : '1.8' }}"
                                d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        Hero Infografis
                    </a>
                    ...
                    <a href="{{ route('testimoni.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeTestimoni ? '2.2' : '1.8' }}"
                                d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                        </svg>
                        Testimoni
                    </a>

                    @php $activeLayanan = request()->routeIs('layanans.*'); @endphp
                    <a href="{{ route('layanans.index') }}"
                        class="relative flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium
                                  transition-all {{ $activeLayanan ? 'nav-item-active bg-indigo-50 text-indigo-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeLayanan ? '2.2' : '1.8' }}"
                    ...
                    <a href="{{ route('agenda.index') }}"
                        ...
                        <svg class="w-5 h-5 {{ $activeAgenda ? 'text-indigo-600' : 'text-gray-400' }}" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeAgenda ? '2.2' : '1.8' }}"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        Agenda Kegiatan
                    </a>
                    ...
                    @if(auth()->user()->hasPermission('view_pengumuman'))
                        ...
                        <a href="{{ route('pengumuman.index') }}"
                            ...
                            <svg class="w-5 h-5 {{ $activePengumuman ? 'text-indigo-600' : 'text-gray-400' }}" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="{{ $activePengumuman ? '2.2' : '1.8' }}"
                    ...
                    <div x-data="{ open: {{ $isPProfilActive ? 'true' : 'false' }} }">
                        <button @click="open = !open"
                            ...
                            <div class="flex items-center gap-3">
                                <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="{{ $isPProfilActive ? '2.2' : '1.8' }}"
                                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                        ...
                        <div x-show="open" style="display: none;" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 -translate-y-2"
                            x-transition:enter-end="opacity-100 translate-y-0" class="pl-9 pr-3 pt-1 pb-2 space-y-1 mt-1">
                            <a href="{{ route('admin.profil-perpustakaan.sejarah') }}"
                                class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.profil-perpustakaan.sejarah') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Sejarah
                                Perpustakaan</a>
                            <a href="{{ route('admin.profil-perpustakaan.tupoksi') }}"
                                class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.profil-perpustakaan.tupoksi') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Tugas
                                Pokok & Fungsi</a>
                            <a href="{{ route('admin.profil-perpustakaan.struktur') }}"
                                class="block px-3 py-2 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('admin.profil-perpustakaan.struktur') ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">Struktur
                                Bidang</a>
                        </div>
                    </div>
                @endif
                ...
                @if(auth()->user()->hasPermission('view_settings'))
                    <p class="px-3 pt-4 pb-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Pengaturan
                    </p>
                    ...
                    <a href="{{ route('settings.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeSettings ? '2.2' : '1.8' }}"
                                d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeSettings ? '2.2' : '1.8' }}" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        Pengaturan Web
                    </a>
                    ...
                    <a href="{{ route('tickets.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeTickets ? '2.2' : '1.8' }}"
                ...
                @if(auth()->user()->hasPermission('view_roles'))
                    ...
                    <a href="{{ route('roles.index') }}"
                        ...
                        <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="{{ $activeRoles ? '2.2' : '1.8' }}"
                ...
                <div class="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-[11px] text-gray-400 truncate">
                            {{ auth()->user()->role?->display_name ?? 'Tanpa Role' }}</p>
                    </div>
            ...
            <header class="sticky top-0 z-10 h-[60px] bg-white/90 backdrop-blur-md
                ...
                <div class="relative group" x-data="{ 
                    ...
                    <button @click="open = true; $nextTick(() => $refs.searchInput.focus())"
                        ...
                        <div
                            class="hidden md:flex absolute -bottom-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                            Ctrl+K
                        </div>
                    </button>
                    ...
                    <div x-show="open" @click.outside="open = false; search = ''"
                        ...
                        <div class="p-3 border-b border-gray-100 relative">
                            <svg class="w-4 h-4 text-gray-400 absolute left-6 top-1/2 -translate-y-1/2" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                        ...
                        <div class="p-2 max-h-72 overflow-y-auto">
                            ...
                            <template x-for="(menu, index) in filteredMenus" :key="index">
                                <a :href="menu.url"
                                    ...
                                    <div
                                        class="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center group-hover:bg-indigo-100 transition-colors">
                                        <svg class="w-4 h-4 text-gray-400 group-hover:text-indigo-600" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13 5l7 7-7 7M5 5l7 7-7 7" />
                                        </svg>
                                    </div>
                                    <span class="text-[13px] font-medium text-gray-700 group-hover:text-indigo-700"
