...
<div class="p-4 sm:p-6 lg:p-8">
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-700">Perbarui informasi agenda dinas.</p>
    </div>

    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
        <form action="{{ route('agenda.update', $agenda->id) }}" method="POST" class="p-6 sm:p-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai', $agenda->tanggal_mulai ? $agenda->tanggal_mulai->format('Y-m-d') : '') }}" required
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-navy-500/20 focus:border-navy-500 transition-colors">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai', $agenda->tanggal_selesai ? $agenda->tanggal_selesai->format('Y-m-d') : '') }}"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-navy-500/20 focus:border-navy-500 transition-colors">
                ...
                <div>
                    ...
                    <input type="text" name="jam_agenda" value="{{ old('jam_agenda', $agenda->jam_agenda) }}" required
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-navy-500/20 focus:border-navy-500 transition-colors">
                ...
                <div>
                    ...
                    <input type="text" name="tempat" value="{{ old('tempat', $agenda->tempat) }}" required
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-navy-500/20 focus:border-navy-500 transition-colors">
                ...
                <div>
                    ...
                    <input type="text" name="narahubung" value="{{ old('narahubung', $agenda->narahubung) }}"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-navy-500/20 focus:border-navy-500 transition-colors">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="5" required
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-navy-500/20 focus:border-navy-500 transition-colors">{{ old('deskripsi', $agenda->deskripsi) }}</textarea>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-navy-600 rounded-xl hover:bg-navy-700 transition-colors shadow-sm">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
