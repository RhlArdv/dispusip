    ...
    <section class="py-24 lg:py-32 px-6 bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                <div>
                    <span class="text-gold-600 font-bold tracking-[0.2em] uppercase text-xs mb-4 flex items-center gap-2">
                        <span class="w-8 h-px bg-gold-500"></span> Akses Cepat
                    </span>
                    <h2 class="text-4xl md:text-6xl font-black tracking-tight text-navy-900 leading-none">
                        Link Penting
                    </h2>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @forelse($linkAccesses as $link)
                    <a href="{{ $link->url }}" target="_blank"
                        class="group bg-white rounded-3xl p-8 border border-navy-50 shadow-[0_10px_30px_rgba(15,36,64,0.05)] hover:shadow-[0_20px_50px_rgba(15,36,64,0.15)] hover:border-gold-200 transition-all duration-300 flex flex-col items-center justify-center text-center gap-4 hover:-translate-y-2">
                        @if($link->icon_svg)
                        ...
                        @else
                            ...
                            <svg class="w-16 h-16 text-gold-500 group-hover:scale-110 group-hover:text-navy-900 transition-all duration-300"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                    d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                            </svg>
                        @endif
                        <h3 class="text-navy-900 font-black text-lg group-hover:text-gold-600 transition-colors">
                            {{ $link->judul }}
                        </h3>
                    </a>
                @empty
                    <p class="col-span-full text-center text-navy-500 font-medium">Belum ada link akses cepat yang tersedia.</p>
                @endforelse
            </div>
        </div>
    </section>
    ...
    <section class="py-24 lg:py-32 px-6 bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                <div>
                    <span class="text-gold-600 font-bold tracking-[0.2em] uppercase text-xs mb-4 flex items-center gap-2">
                        <span class="w-8 h-px bg-gold-500"></span> Media Sosial
                    </span>
                    <h2 class="text-4xl md:text-6xl font-black tracking-tight text-navy-900 leading-none">
                        Ikuti Kami<br>
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-gold-600">@dispusip_padang</span>
                    </h2>
                </div>
                <a href="https://instagram.com/dispusip_padang" target="_blank"
                    class="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-pink-500 via-purple-500 to-orange-500 text-white font-bold rounded-full hover:shadow-lg hover:shadow-pink-500/30 transform hover:-translate-y-1 transition-all duration-300">
            ...
            @forelse($instagramPosts as $posts)
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    @foreach($posts as $item)
                        <a href="{{ $item['link'] ?? '#' }}" target="_blank"
                            class="group relative rounded-3xl overflow-hidden aspect-square bg-navy-50 shadow-[0_10px_30px_rgba(15,36,64,0.08)] hover:shadow-[0_20px_50px_rgba(15,36,64,0.2)] hover:shadow-pink-500/20 transition-all duration-500 hover:-translate-y-2">
                            @if(isset($item['image']) && !empty($item['image']))
                                <img src="{{ $item['image'] }}" alt="Instagram Post"
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                            @else
                                <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-navy-800 to-navy-950">
                                    <svg class="w-16 h-16 text-gold-400" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                                    </svg>
                                </div>
                            ...
                            <!-- Overlay on hover -->
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-navy-900/80 via-navy-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                                <div
                                    class="text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                    <svg class="w-10 h-10 text-white mx-auto mb-2" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                                    </svg>
                                    <p class="text-white font-bold text-sm">Lihat di Instagram</p>
                                </div>
                            </div>

                            <!-- Instagram likes/comments badge -->
                            @if(isset($item['likes']) || isset($item['comments']))
                                <div
                                    class="absolute top-3 right-3 flex items-center gap-1.5 bg-white/90 backdrop-blur-sm px-2.5 py-1.5 rounded-full shadow-md">
                                    <svg class="w-3.5 h-3.5 text-pink-500" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                                    </svg>
                                    <span class="text-xs font-bold text-navy-900">{{ $item['likes'] ?? 0 }}</span>
                                </div>
                            @endif
                        </a>
                    @endforeach
            ...
            @empty
                <div class="text-center py-16 bg-navy-50 rounded-3xl border border-navy-100">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-pink-500 via-purple-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-black text-navy-900 mb-2">Ikuti Kami di Instagram</h3>
                    <p class="text-navy-600 font-medium mb-6">Dapatkan update terbaru seputar kegiatan dan layanan perpustakaan.
                    </p>
                    <a href="https://instagram.com/dispusip_padang" target="_blank"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 via-purple-500 to-orange-500 text-white font-bold rounded-full hover:shadow-lg transition-all">
                        <span>@dispusip_padang</span>
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
    ...
    <section class="py-24 lg:py-32 px-6 bg-white border-t border-navy-50 relative">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
                ...
                <!-- Left: Typography -->
                <div
                    class="lg:col-span-5 lg:sticky lg:top-32 mb-10 lg:mb-0 relative z-10 bg-white/80 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none p-2 lg:p-0">
