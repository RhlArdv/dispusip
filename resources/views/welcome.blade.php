                    ...
                    <a href="{{ $link->url }}" target="_blank"
                       class="group bg-white rounded-3xl p-8 border border-navy-50 shadow-[0_10px_30px_rgba(15,36,64,0.05)] hover:shadow-[0_20px_50px_rgba(15,36,64,0.15)] hover:border-gold-200 transition-all duration-300 flex flex-col items-center justify-center text-center gap-4 hover:-translate-y-2">
                        ...
                        @else
                            ...
                            <svg class="w-16 h-16 text-gold-500 group-hover:scale-110 group-hover:text-navy-900 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                <div>
                    ...
                    <h2 class="text-4xl md:text-6xl font-black tracking-tight text-navy-900 leading-none">
                        Ikuti Kami<br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-gold-600">@dispusip_padang</span>
                    </h2>
                </div>
                    ...
                    @foreach($posts as $item)
                        <a href="{{ $item['link'] ?? '#' }}" target="_blank"
                           class="group relative rounded-3xl overflow-hidden aspect-square bg-navy-50 shadow-[0_10px_30px_rgba(15,36,64,0.08)] hover:shadow-[0_20px_50px_rgba(15,36,64,0.2)] hover:shadow-pink-500/20 transition-all duration-500 hover:-translate-y-2">
                            ...
                            <!-- Overlay on hover -->
                            <div class="absolute inset-0 bg-gradient-to-t from-navy-900/80 via-navy-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                            ...
                            @if(isset($item['likes']) || isset($item['comments']))
                                <div class="absolute top-3 right-3 flex items-center gap-1.5 bg-white/90 backdrop-blur-sm px-2.5 py-1.5 rounded-full shadow-md">
            ...
            @empty
                <div class="text-center py-16 bg-navy-50 rounded-3xl border border-navy-100">
                    <div class="w-20 h-20 bg-gradient-to-br from-pink-500 via-purple-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-black text-navy-900 mb-2">Ikuti Kami di Instagram</h3>
                    <p class="text-navy-600 font-medium mb-6">Dapatkan update terbaru seputar kegiatan dan layanan perpustakaan.</p>
                    <a href="https://instagram.com/dispusip_padang" target="_blank"
