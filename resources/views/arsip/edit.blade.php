...
<div class="flex items-center justify-between flex-wrap gap-3">
    <div>
        ...
        <h1 class="text-xl font-bold text-gray-900">Edit Arsip</h1>
    </div>
</div>
@endsection
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
    <form method="POST" action="{{ route('arsip.update', $arsip->id) }}" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <select name="tingkat_perkembangan"
                    ...
                    @foreach($tingkatPerkembanganOptions as $option)
                        <option value="{{ $option }}" {{ old('tingkat_perkembangan', $arsip->tingkat_perkembangan) == $option ? 'selected' : '' }}>{{ $option }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select name="bentuk"
                    ...
                    @foreach($bentukOptions as $option)
                        <option value="{{ $option }}" {{ old('bentuk', $arsip->bentuk) == $option ? 'selected' : '' }}>{{ $option }}</option>
                    @endforeach
                </select>
                @error('bentuk')
                    <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
            ...
            <div>
                ...
                <select name="keterangan"
                    ...
                    @foreach($keteranganOptions as $option)
                        <option value="{{ $option }}" {{ old('keterangan', $arsip->keterangan) == $option ? 'selected' : '' }}>{{ $option }}</option>
                    @endforeach
                </select>
                @error('keterangan')
                    <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
            ...
            <div class="border-t border-gray-100 pt-5">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="indeks" value="{{ old('indeks', $arsip->indeks) }}" placeholder="Contoh: A-001"
                           class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm
                                  focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-colors
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" rows="3" placeholder="Deskripsi arsip..."
                              class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm
                                     focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-colors
                                     resize-none @error('deskripsi') border-red-300 @enderror">{{ old('deskripsi', $arsip->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="tahun" value="{{ old('tahun', $arsip->tahun) }}" placeholder="2024" min="1900" max="2100"
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-colors
                    ...
                    <div>
                        ...
                        <input type="text" name="jumlah" value="{{ old('jumlah', $arsip->jumlah) }}" placeholder="1"
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-colors
            ...
            <div class="bg-gray-50 rounded-xl p-5">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="rak" value="{{ old('rak', $arsip->rak) }}" placeholder="A1"
                    ...
                    <div>
                        ...
                        <input type="text" name="roll_o_pack" value="{{ old('roll_o_pack', $arsip->roll_o_pack) }}" placeholder="1"
                               class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-100 transition-colors">
                        @error('roll_o_pack')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="boks" value="{{ old('boks', $arsip->boks) }}" placeholder="12"
                               class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-100 transition-colors">
                        @error('boks')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="bungkus" value="{{ old('bungkus', $arsip->bungkus) }}" placeholder="Map"
                               class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-100 transition-colors">
                        @error('bungkus')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="buku" value="{{ old('buku', $arsip->buku) }}" placeholder="Buku 1"
                               class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-100 transition-colors">
                        @error('buku')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="sampul" value="{{ old('sampul', $arsip->sampul) }}" placeholder="Biru"
                               class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                                      focus:outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-100 transition-colors">
                        @error('sampul')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
