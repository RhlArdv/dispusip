...
<div class="flex items-center justify-between flex-wrap gap-3">
    <div>
        ...
        <h1 class="text-xl font-bold text-gray-900">Tambah Kegiatan Baru</h1>
    </div>
</div>
@endsection
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
    <form method="POST" action="{{ route('kegiatan.store') }}" id="form-kegiatan" enctype="multipart/form-data" class="p-6">
        @csrf
