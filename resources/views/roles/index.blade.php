...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4" id="roles-grid">
    ...
    @php
        $isSystem = in_array($role->name, ['admin', 'arsip', 'pustaka']);
        $colorMap = [
            'admin'    => ['bg'=>'bg-purple-500','light'=>'bg-purple-50','text'=>'text-purple-700','border'=>'border-purple-100'],
            'arsip'    => ['bg'=>'bg-amber-500', 'light'=>'bg-amber-50',  'text'=>'text-amber-700',  'border'=>'border-amber-100'],
            'pustaka'  => ['bg'=>'bg-teal-500',   'light'=>'bg-teal-50',   'text'=>'text-teal-700',   'border'=>'border-teal-100'],
        ];
