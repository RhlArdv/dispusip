                    ...
                    <a href="https://onesearch.id/" target="_blank"
                        ...
                        <div class="relative z-10 flex flex-col justify-between h-full">
                            ...
                            <div>
                                ...
                                <p class="text-navy-600 font-medium text-sm">Pintu pencarian tunggal untuk semua koleksi
                                    publik dari perpustakaan di Indonesia.</p>
                            </div>
                        </div>
                    </a>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="#"
                        ...
                        <div
                            class="w-20 h-20 rounded-full bg-navy-50 text-navy-900 flex items-center justify-center mb-6 group-hover:bg-gold-500 group-hover:text-white transition-colors">
                        ...
                        <h3 class="text-xl font-bold text-navy-900 group-hover:text-gold-600 transition-colors">Layanan ISBN
                            & QRCBN</h3>
                        <p class="text-sm text-navy-500 mt-3 leading-relaxed">Pengajuan nomor standar buku dan kode QR untuk
                            karya tulis Anda.</p>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <h3 class="text-xl font-bold text-navy-900 group-hover:text-gold-600 transition-colors">Data
                            Perpustakaan</h3>
                        <p class="text-sm text-navy-500 mt-3 leading-relaxed">Akses pangkalan data perpustakaan menyeluruh
                            se-Kota Padang.</p>
                    </a>
                    ...
                    <a href="{{ route('jdih.index') }}"
                        ...
                        <h3 class="text-xl font-bold text-navy-900 group-hover:text-gold-600 transition-colors">JDIH
                            Perpustakaan</h3>
                        <p class="text-sm text-navy-500 mt-3 leading-relaxed">Jaringan Dokumentasi dan Informasi Hukum
                            perpustakaan.</p>
                    </a>
                    ...
                    <a href="{{ url('/#faq') }}"
                        ...
                        <h3 class="text-xl font-bold text-navy-900 group-hover:text-gold-600 transition-colors">FAQ
                            Perpustakaan</h3>
                        <p class="text-sm text-navy-500 mt-3 leading-relaxed">Cari jawaban dari pertanyaan umum seputar
                            layanan kami.</p>
                    </a>
                </div>
            </div>
