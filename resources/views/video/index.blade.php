...
<style>
    /* DataTables styling */
    #tabel-video_wrapper .dataTables_length,
    #tabel-video_wrapper .dataTables_filter {
        display: flex;
        align-items: center;
        gap: 0.5rem;
        font-size: 0.8125rem;
    ...
    #tabel-video_wrapper .dataTables_length select {
        appearance: none;
    ...
    #tabel-video_wrapper .dataTables_length select:focus {
        outline: none;
        border-color: #38bdf8;
        box-shadow: 0 0 0 3px rgba(56, 189, 248, 0.15);
    }
    #tabel-video_wrapper .dataTables_filter input {
    ...
    #tabel-video_wrapper .dataTables_filter input:focus {
        outline: none;
        border-color: #38bdf8;
        box-shadow: 0 0 0 3px rgba(56, 189, 248, 0.15);
    }
    #tabel-video tbody tr { border-bottom: 1px solid #f9fafb; }
    #tabel-video tbody tr:hover td { background: #f0f9ff !important; }
    #tabel-video thead tr th { border-bottom: 2px solid #f3f4f6 !important; }

    #tabel-video_wrapper .dataTables_info {
        font-size: 0.8125rem;
        color: #6b7280;
        padding-top: 0.75rem;
    }
    #tabel-video_wrapper .dataTables_paginate {
        display: flex;
        align-items: center;
        justify-content: flex-end;
        gap: 0.25rem;
    ...
    #tabel-video_wrapper .dataTables_paginate span {
        display: inline-flex;
        gap: 0.25rem;
    }
    #tabel-video_wrapper .dataTables_paginate .paginate_button {
    ...
    #tabel-video_wrapper .dataTables_paginate .previous,
    #tabel-video_wrapper .dataTables_paginate .next {
        border: 1px solid #e5e7eb !important;
        background: #fff !important;
        margin: 0 0.125rem;
    }
    #tabel-video_wrapper .dataTables_paginate .previous:hover:not(.disabled),
    #tabel-video_wrapper .dataTables_paginate .next:hover:not(.disabled) {
        border-color: #38bdf8 !important;
        color: #0284c7 !important;
        background: #f0f9ff !important;
    }
    #tabel-video_wrapper .dataTables_paginate .previous.disabled,
    #tabel-video_wrapper .dataTables_paginate .next.disabled {
        opacity: 0.4;
        cursor: not-allowed;
    }
    #tabel-video_wrapper .dataTables_paginate .paginate_button:not(.previous):not(.next):hover:not(.current) {
        background: #f0f9ff !important;
        color: #0284c7 !important;
        border-color: #bae6fd !important;
    }
    #tabel-video_wrapper .dataTables_paginate .paginate_button.current,
    #tabel-video_wrapper .dataTables_paginate .paginate_button.current:hover {
    ...
    $(document).ready(function() {
        $('#tabel-video').DataTable({
            ...
            language: {
                ...
                info: 'Menampilkan _START_ – _END_ dari _TOTAL_ video',
