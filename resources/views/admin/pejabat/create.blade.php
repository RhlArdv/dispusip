...
<div class="flex items-center gap-4">
    ...
    <div>
        <h1 class="text-xl font-bold text-gray-900">Tambah Pejabat</h1>
        <p class="text-[13px] text-gray-500 mt-0.5">Tambahkan data pimpinan atau pejabat instansi</p>
    </div>
</div>
@endsection
        ...
        <div class="p-6 md:p-8 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama') }}"
                       ...
                       placeholder="Contoh: Dr. Hendri Septa, M.Si">
            ...
            <div>
                ...
                <textarea name="keterangan" rows="3"
                          ...
                          placeholder="Deskripsi singkat tentang pejabat ini...">{{ old('keterangan') }}</textarea>
                @error('keterangan') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
            </div>

            {{-- Foto --}}
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Foto Pejabat</label>
                ...
                <p class="text-xs text-gray-500 mt-1.5">Format: JPG, PNG. Maks: 2MB. Rasio wajah (portrait) direkomendasikan.</p>
            ...
            <div class="pt-2 border-t border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="url" name="twitter" value="{{ old('twitter') }}" placeholder="https://x.com/..."
                               class="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all">
                    </div>
                    <div class="flex items-center gap-3">
